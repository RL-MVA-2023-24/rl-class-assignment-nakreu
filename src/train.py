...
# Define the ReplayBuffer class as was demonstrated in class
class ReplayBuffer:
...
class DQN_Agent:
    ...
    #Define the class to do more rigourous monitoring as was suggested in class
    def MC_eval(self, env, nb_trials):
        #Monte-Carlo evaluation of the total reward
        MC_total_reward = []

        #Monte-Carlo evalition of discounted reward
    ...
    #Compute an estimation of the state value function as suggested in class (gives a partial measure of the quality of the policy)
    ...
    def train(self, env, max_episode):
        ...
        while episode < max_episode:
            ...
            #EMEA strategy for smoother updates (as done in DDQN paper)
            ...
            if done or trunc:
                ...
                if self.monitoring_nb_trials > 0 and episode % self.monitor_every == 0:
                    ...
                    print("Episode ", '{:2d}'.format(episode),
                          ...
                          ", V0 ", '{:6.0f}'.format(V0),
                          sep='')
                    #Keep the best performing policy
...
class ProjectAgent:
    ...
    def load(self):
        path = os.getcwd() + "/src/dqn_agent_1.pth"
        self.dqn_agent.load(path)


# Define the fill_buffer function
...
config = {'nb_actions': nb_actions,
          ...
          'monitoring_nb_trials': 100,
          'monitor_every': 100,
          'save_path': './dqn_agent_best.pth',
          'save_every': 100}
...
if __name__ == "__main__":
    ...
    # Fill the buffer
    fill_buffer(env, agent, config["buffer_size"])
